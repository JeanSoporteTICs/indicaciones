...
<body class="peds-bg">
    <div class="app-shell d-flex flex-column min-vh-100">
        ...
        <div class="section-status-board" id="sectionStatusBoard" aria-label="Estado de secciones del formulario">
            <a class="section-status-item" href="#cardDatosBasicos" data-section-status="datos" data-step="1">
                <span class="section-status-check"><i class="fas fa-check"></i><span class="section-status-number">1</span></span>
                <span>Datos Básicos del Paciente</span>
            </a>
            <a class="section-status-item" href="#cardAntropometricos" data-section-status="antropometricos" data-step="2">
                <span class="section-status-check"><i class="fas fa-check"></i><span class="section-status-number">2</span></span>
                <span>Datos Antropométricos</span>
            </a>
            <a class="section-status-item" href="#cardIndicaciones" data-section-status="indicaciones" data-step="3">
                <span class="section-status-check"><i class="fas fa-check"></i><span class="section-status-number">3</span></span>
                <span>Indicaciones Médicas</span>
            </a>
            <a class="section-status-item" href="#cardMedicamentos" data-section-status="medicamentos" data-step="4">
                <span class="section-status-check"><i class="fas fa-check"></i><span class="section-status-number">4</span></span>
        ...
        <form id="hospitalizacionForm" class="mb-4">
            <!-- Datos Básicos -->
            <div class="card shadow-sm mb-4 medicamentos-card" id="cardDatosBasicos">
            ...
            <!-- Antropométricos -->
            <div class="card" id="cardAntropometricos">
                <div class="card-header">
            ...
            <div class="card" id="cardIndicaciones">
                <div class="card-header">
            ...
            <!-- Medicamentos (única) -->
            <div class="card shadow-sm mb-4 medicamentos-card" id="cardMedicamentos">
                <div class="card-header">
